            ...
            <div class="footer-top">
                <div class="footer-brand" data-aos="fade-up">
                    ...
                    <div class="footer-social">
                        <a href="<?= e(getSetting('facebook_url', '#')) ?>" aria-label="Facebook" target="_blank" rel="noopener">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                        <a href="<?= e(getSetting('instagram_url', '#')) ?>" aria-label="Instagram" target="_blank" rel="noopener">
                        ...
                        <a href="https://wa.me/<?= e(getSetting('whatsapp_number', '')) ?>" aria-label="WhatsApp" target="_blank" rel="noopener">
                ...
                <div class="footer-column" data-aos="fade-up" data-aos-delay="200">
                    <h4>Services</h4>
                    <ul>
                        <li><a href="<?= SITE_URL ?>/espaces-services.php#hypermarche">Hypermarché</a></li>
                        <li><a href="<?= SITE_URL ?>/espaces-services.php#cinema">Cinéma</a></li>
                        <li><a href="<?= SITE_URL ?>/espaces-services.php#aquarium">Aquarium</a></li>
                        <li><a href="<?= SITE_URL ?>/espaces-services.php#bien-etre">Bien-être</a></li>
                        <li><a href="<?= SITE_URL ?>/espaces-services.php#jeux">Espaces de Jeux</a></li>
                    </ul>
                </div>
